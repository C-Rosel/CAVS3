...
import { IoMapSharp, IoHomeSharp, IoCameraSharp, IoRadioSharp, IoBarChartSharp  } from "react-icons/io5";
import './Sidebar.css'
...
const Sidebar = ({ sidebarOpen, activePage, setActivePage }) => {
    return (
        <nav className={`${sidebarOpen ? "open" : ""} sidebar`}>
            ...
            <div className='sidebarBtn' onClick={() => setActivePage("Dashboard")}> <IoHomeSharp size={50}/> Dashboard </div>
